...
while ($senhaDigitada !== $senhaCorreta && $tentativas < 3) {
    ...
    $senhaDigitada = "1234";
    echo "<p>A senha digitada novavemente foi  a {$senhaDigitada}<p>";
}
...
while ($estoqueAtual > 0) {
    $estoqueAtual--;
    $vendasRealizadas++;
    echo "Venda $vendasRealizadas realizada. Estoque restante: $estoqueAtual</p>";
}

echo "Estoque esgotado após $vendasRealizadas vendas.</P>";
